...
class NPC(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
    val idIndex: Int
...
class Talk(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
    companion object {
...
class Skill(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
    companion object {
        val NAME_SIZE_INDEX = 0
        val NAME_INDEX = 1
    }
...
class Scene(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
...
class ShopItem(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
...
class GSItem(byteData: ByteBuffer, itemSize: Int, charset: Charset = Charset.forName("UTF-8")) : TSModel(byteData, itemSize, charset) {
